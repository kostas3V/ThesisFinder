                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 style="font-family: 'Raleway', sans-serif;">Edit Discusion</h3>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <form action="{{route('discusions.update', $discusion->id)}}" method="POST">                            
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" value="{{isset($discusion) ? $discusion->subject : ''}}">
                            </div>
        
                            <div class="form-group">
                                <label for="info">Info</label>
                                <input id="info" type="hidden" name="info" value="{{isset($discusion) ? $discusion->info : ''}}">
